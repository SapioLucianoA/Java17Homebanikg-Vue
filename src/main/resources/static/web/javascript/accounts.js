...
createApp({
  ...
  methods: {
    ...
    removeAccount(number, isActive) {
      if (confirm("Are you sure you want to perform the action? Remember that this action is permanent, and the account cannot be deleted if it has money or owes money to the bank.")) {
